...
int main(int argc, char *const argv[])
{
  ...
  uint8_t defaultKeys[][6] = {
    // Add Custom Keys Here - Type A (OLD)
    {0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
    {0x32, 0xea, 0x0f, 0x9b, 0xd7, 0xbf}, // 32ea0f9bd7bf
    {0x73, 0x22, 0x0e, 0x6d, 0x4c, 0xe4}, // 73220e6d4ce4
    {0x79, 0x58, 0xe6, 0xb1, 0x5a, 0x1b}, // 7958e6b15a1b
    {0xf6, 0x18, 0xb3, 0xd7, 0x85, 0x5a}, // f618b3d7855a
    // Add Custom Keys Here - Type B (OLD)             
    {0xf2, 0x3d, 0xd2, 0x56, 0x54, 0xa0}, // f23dd25654a0 - Sector 0
    {0x8f, 0x57, 0xba, 0xb8, 0x72, 0xd3}, // 8f57bab872d3 - Sector 1
    {0x3a, 0x4b, 0x4b, 0x97, 0xe3, 0xbc}, // 3a4b4b97e3bc - Sector 2
    {0xae, 0x60, 0x77, 0xa1, 0x98, 0x9d}, // ae6077a1989d - Sector 3
    {0x8f, 0x17, 0x11, 0x42, 0xb7, 0xf3}, // 8f171142b7f3 - Sector 4, 5
    {0x53, 0x6f, 0x66, 0x69, 0x61, 0x4d}, // 536f6669614d - Sector 6, 7, 8, 9, 10, 11, 12, 13, 14
    {0xf1, 0xaf, 0xa4, 0xda, 0x94, 0x9f}, // f1afa4da949f - Sector 15
    // Add Custom Keys Here - Type A (NEW - 2019-09-11)
    {0x67, 0x36, 0x2d, 0xac, 0xe5, 0x27}, // 67362dace527 - Sector 0
    {0xf9, 0x3c, 0x98, 0x65, 0x5b, 0x9c}, // f93c98655b9c - Sector 1
    {0x54, 0xa0, 0x28, 0x81, 0x8a, 0xc7}, // 54a028818ac7 - Sector 2
    {0x3e, 0x93, 0xcf, 0x06, 0x44, 0xb6}, // 3e93cf0644b6 - Sector 3
    {0x22, 0x04, 0xb9, 0xfb, 0xf0, 0x33}, // 2204b9fbf033 - Sector 4
    {0xd1, 0xb4, 0x4a, 0x9d, 0xf0, 0x5f}, // d1b44a9df05f - Sector 5
    {0x21, 0xcc, 0x00, 0x7a, 0xd8, 0x1c}, // 21cc007ad81c - Sector 6
    {0xd2, 0x26, 0x82, 0x62, 0x71, 0x0f}, // d2268262710f - Sector 7
    {0x9f, 0xe7, 0xc5, 0xbe, 0x7d, 0xff}, // 9fe7c5be7dff - Sector 8
    {0x78, 0xfc, 0xd4, 0x47, 0x0c, 0x50}, // 78fcd4470c50 - Sector 9
    {0x0d, 0xc1, 0xdd, 0x7c, 0x8e, 0xa2}, // 0dc1dd7c8ea2 - Sector 10
    {0x03, 0xde, 0x2c, 0xeb, 0x2e, 0xa1}, // 03de2ceb2ea1 - Sector 11
    {0x8f, 0xbc, 0xed, 0x38, 0x7b, 0xf4}, // 8fbced387bf4 - Sector 12
    {0xef, 0x24, 0xfe, 0x3b, 0x4c, 0xf7}, // ef24fe3b4cf7 - Sector 13
    {0xb1, 0xea, 0x40, 0xb2, 0xca, 0xa6}, // b1ea40b2caa6 - Sector 14
    // Add Custom Keys Here - Type B (NEW - 2019-09-11)
    {0x63, 0x3a, 0x01, 0x0f, 0xa3, 0xc3}, // 633a010fa3c3 - Sector 0
    {0x67, 0xec, 0x0a, 0x47, 0xb0, 0xfb}, // 67ec0a47b0fb - Sector 1
    {0xb2, 0xe8, 0x7e, 0x53, 0xc5, 0xa0}, // b2e87e53c5a0 - Sector 2
    {0x79, 0xe1, 0x22, 0x80, 0xe2, 0x19}, // 79e12280e219 - Sector 3
    {0x45, 0x37, 0xfd, 0x23, 0x8c, 0x8e}, // 4537fd238c8e - Sector 4
    {0xcf, 0xa5, 0x26, 0x83, 0x5a, 0x1f}, // cfa526835a1f - Sector 5
    {0xc0, 0x97, 0xd0, 0xa8, 0x54, 0x46}, // c097d0a85446 - Sector 6
    {0x73, 0x0b, 0xb7, 0xb8, 0xb3, 0xde}, // 730bb7b8b3de - Sector 7
    {0x61, 0xae, 0x2d, 0x92, 0x0c, 0x79}, // 61ae2d920c79 - Sector 8
    {0xb6, 0x38, 0xca, 0xf7, 0x35, 0x7b}, // b638caf7357b - Sector 9
    {0x4c, 0x6a, 0x68, 0x66, 0xb9, 0x34}, // 4c6a6866b934 - Sector 10
    {0x93, 0xe0, 0x11, 0x8b, 0x21, 0xed}, // 93e0118b21ed - Sector 11
    {0xf5, 0x7c, 0xa9, 0x5c, 0x6e, 0xdd}, // f57ca95c6edd - Sector 12
    
    {0x8b, 0x44, 0xd3, 0x03, 0xd6, 0x2f}, // 8b44d303d62f - Sector 13
    {0x3a, 0xbf, 0x84, 0x31, 0x00, 0x3b}, // 3abf8431003b - Sector 14
    // Default Keys
